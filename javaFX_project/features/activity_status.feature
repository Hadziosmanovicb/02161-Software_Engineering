# Filnavn: activity_status.feature
# Relaterede filer: Activity.java
# Formål:
# Tester ændring og validering af status på aktiviteter.
# Dækker workflows for færdiggørelse, godkendelse og afvisning af aktiviteter,
# samt visning af status og færdiggørelsesprocent.
